...
abstract class $OutcomeDTOCopyWith<$Res> {
  ...
  @useResult
  $Res call({int outcomeId, String outcomeName, double? odds});
}
...
class _$OutcomeDTOImpl implements _OutcomeDTO {
  ...
  @override
  String toString() {
    return 'OutcomeDTO(outcomeId: $outcomeId, outcomeName: $outcomeName, odds: $odds)';
  }
...
abstract class _OutcomeDTO implements OutcomeDTO {
  const factory _OutcomeDTO(
      ...
      required final double? odds}) = _$OutcomeDTOImpl;
